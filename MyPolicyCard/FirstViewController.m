...
- (void) doInits {
    ...
    Carrier *c4 = [[Carrier alloc]initWithPlan:@"Lincoln: Life/AD&D LTD" andPolicyNo:@[@"0122960",@"0122961"] andPhoneNo:@"800.423.2765" andWeb:@"www.lfg.com"];
    ...
    Carrier *c6 = [[Carrier alloc]initWithPlan:@"FSA: Benefit Dynamics" andPolicyNo:@[] andPhoneNo:@"925.956.0505" andWeb:@"www.pensiondynamics.com"];
